module.exports = {
	...
	//>>TCB Properties
	basename: String,// local directory of file
	filePath: String,// local directory of file
	thumbFilePath: String,// local directory of file
	mediumFilePath: String,// local directory of file
	urlPath: String,//path part of URL(after host and port)
	thumbUrlPath: String,// local directory of file
