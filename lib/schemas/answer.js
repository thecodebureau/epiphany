module.exports = {
	//downvoteCount: Number,//	The number of downvotes this question, answer or comment has received from the community.
	//parentItem: Question,//The parent of a question, answer or item in general.
	//upvoteCount: Number,//	The number of upvotes this question, answer or comment has received from the community.
	...
	//position: Number  or String,//The position of an item in a series or sequence of items.
