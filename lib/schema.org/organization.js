module.exports = function(mongoose, schemas) {
	return new mongoose.Schema({
		...
		//>>Organization
		address: schemas.PostalAddress.objectify(),//	Physical address of the item.
		...
		//founder: schemas.Person.objectify(),//A person who founded this organization. Supersedes founders.
